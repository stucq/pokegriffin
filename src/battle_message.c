...
static const u8 sText_WildPkmnAppeared[] = _("petah the {B_OPPONENT_MON1_NAME} is here\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("holy crap lois it's {B_OPPONENT_MON1_NAME}\p");
